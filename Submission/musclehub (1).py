...
group_counts = [2504, 2500]
plt.pie(group_counts, autopct = '%0.1f%%')
plt.axis('equal')
...
# p-value is less than 0.05, therefore we reject the null hypothesis in favour of the alternative.
# The difference between the two test groups (A and B) is statistically significant. 
...
# p-value is greater than 0.05, therefore we cannot reject the null hypothesis in favour of the alternative.
# The difference between the two test groups (A and B) is NOT statistically significant.
...
plt.title('Percentage of all visitors who apply')

plt.savefig("bar_visitors-who-apply.png")
...
values_2 = [80.00, 76.92]

plt.figure(figsize=(10,8))

plt.bar(range(len(x_labels)), values_2)
...
plt.savefig("bar_applicants-who-buy.png")
...
plt.bar(range(len(x_labels)), values_3)

ax4 = plt.subplot()
ax4.set_xticks(range(len(x_labels)))
ax4.set_xticklabels(x_labels)

ax4.yaxis.set_major_formatter(PercentFormatter(100, 0))

plt.title('Percentage of visitors who purchase a membership')

plt.savefig("bar_visitors-who-buy.png")
